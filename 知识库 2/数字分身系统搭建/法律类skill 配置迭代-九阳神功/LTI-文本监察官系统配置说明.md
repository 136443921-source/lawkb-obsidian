...
## 相关笔记
- [[合同审查报告-简约版-使用说明]] (语义相似度: 0.294, 共同关键词: 输出, LTI, 风险)
- [[律师AI提示词使用指南从入门到精通]] (语义相似度: 0.244, 共同关键词: 输出, 法律, 法条)
- [[V1.1输出拦截器——法律文书常见错误案例库]] (语义相似度: 0.214, 共同关键词: 输出, 规则, AI)
- [[法律检索助手迭代配置说明v2]] (语义相似度: 0.185, 共同关键词: 输出, 法律, 引用)
- [[法律文书写作助手skill 配置说明书v2.0]] (语义相似度: 0.161, 共同关键词: 输出, 是否, 法律)
