  ...
  "rules": [
    {
      ...
      "replacement": "[[中华人民共和国民法典|中华人民共和国民法典]]"
    },
    {
      "rule_id": "R002",
      "category": "术语规范",
...
## 相关笔记
- [[谈案律师技能设计方案_20260528]] (共现关键词: text, ###, 证据)
- [[谈案律师技能设计方案]] (共现关键词: text, 证据, 合同)
- [[LTI-文本监察官系统配置说明]] (共现关键词: 合同, 文本, 说明)
- [[知识飞轮系统/03-连接/概念页/谈案律师技能设计方案_20260528]] (共现关键词: 合同, 仲裁, text)
- [[小强律师数字分身系统/数字分身系统搭建/法律类skill 配置迭代-九阳神功/文书红队推演配置]] (共现关键词: 民法, 合同, 仲裁)
- [[提示词库/律师用AI梳理证据链的5个重点附提示词]] (共现关键词: 合同, 仲裁)
- [[小强律师数字分身系统/数字分身系统搭建/法律类skill 配置迭代-九阳神功/LTI-文本监察官系统配置说明]] (共现关键词: 文本, 监察官, 系统配置)
- [[self.md-20260817]] (共现关键词: self, 民法, 合同)
- [[月度回灌日志]] (共现关键词: self, 合同)
- [[案例库/最佳实践库/最佳实践模板]] (共现关键词: 法条, 合同)
- [[学习笔记/AI每日学习报告/小强律师人伤法自学每日报告-2026年06月28日]] (共现关键词: 法条, 民法, 合同)
- [[知识库/医法知识库/工伤赔偿项目全景表13项6维度建议收藏]] (共现关键词: 法条, 合同)
- [[学习笔记/AI每日学习报告/小强律师人伤法自学每日报告-2026年06月19日]] (共现关键词: 合同, 行政)
- [[人伤专业领域/工伤/工伤认定2026最新裁判与规则]] (共现关键词: 合同, 行政)
- [[人伤专业领域/工伤/工伤保险条例-核心条文摘录]] (共现关键词: 合同, 行政)
- [[案例库/法考必考的最新入库案例]] (共现关键词: 裁定, 行政, 民法)
- [[知识飞轮系统/03-连接/概念页/律师数字分身系统技能配置迭代方案 1.0]] (共现关键词: ---, 裁定, 民法)
- [[LTI文本监控器v4.0迁移与调用规范]] (共现关键词: LTI, 文本)
- [[小强律师数字分身系统/数字分身系统搭建/法律类skill 配置迭代-九阳神功/法律检索助手迭代配置说明v2]] (共现关键词: 说明, 行政)
- [[法律文书写作助手 Skill配置说明v1.0]] (共现关键词: 说明, 仲裁)
- [[法随案例库 MCP 集成说明]] (共现关键词: 说明, 行政)
- [[提示词库/WorkBuddy50个实用提示词]] (共现关键词: 违约, 说明, 行政)
- [[提示词库/律师AI提效的7套黄金提示词]] (共现关键词: 行政法, 民法, 行政)
- [[律师AI提示词清单（1.0 版）]] (共现关键词: ---, 行政法, 行政)
- [[提示词库/律师AI提示词使用指南从入门到精通]] (共现关键词: 仲裁, 民法, 法条)
- [[经验卡片-要素式文书实务-示范文本首选率超75%]] (共现关键词: 违约, 文本, 行政)
- [[提示词库/法律文书防幻觉提示词_LTI校验版]] (共现关键词: 文本, 违约, 法条)
- [[小哲AI 学伴系统/小哲AI 学伴智能体搭建方案]] (共现关键词: 文本, 行政)
- 合同审查报告-简约版-使用说明 
- [[提示词库/律师AI提示词使用指南从入门到精通|律师AI提示词使用指南从入门到精通]] 
- [[智能体技能库/LTI文本监控器系统/V1.1输出拦截器——法律文书常见错误案例库|V1.1输出拦截器——法律文书常见错误案例库]] 
- [[小强律师数字分身系统/数字分身系统搭建/法律类skill 配置迭代-九阳神功/法律检索助手迭代配置说明v2|法律检索助手迭代配置说明v2]]|法律检索助手迭代配置说明v2|法律检索助手迭代配置说明v2|法律检索助手迭代配置说明v2|法律检索助手迭代配置说明v2|法律检索助手迭代配置说明v2|法律检索助手迭代配置说明v2|法律检索助手迭代配置说明v2 
