...
files = sorted(glob.glob(f"{DIR}/R-GZ-0*.md"))
...
for f in files:
    ...
    bad = [x for x in re.findall(r"[A-Za-z]{6,}", raw)
           if x.lower() not in ("https", "qcc", "legal", "com", "regulation",
                                ...
                                "date", "title", "type", "library",
                                "pending", "statute", "text", "yuandian", "false", "true",
                                "aliases", "widgets", "sort", "elements", "ruling",
                                "support", "reject", "sort", "false", "true",
                                "statute_text_pending", "yuandian",
                                "burden", "negative", "sample", "note", "step",
                                "ruling", "elements", "links", "related", "desc",
                                "frontmatter")]
    if bad:
