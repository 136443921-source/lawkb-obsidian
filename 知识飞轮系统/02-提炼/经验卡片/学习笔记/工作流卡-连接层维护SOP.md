...
- 领域枢纽：[[连接枢纽-学习笔记]]
- 同域语义关联：
  - [[R-LN-020-电子证据采信以真实性合法性关联性三性完整为前提缺失原始载体或非法取证即排除]] · [[R-LN-012-公司决议效力瑕疵三类型及救济时效]] · [[R-LN-018-司法鉴定事项不得夹带法律判断责任划分由法院决定]] · [[R-LN-015-法院依职权调查证据亦须质证不得径行认定未主张事实]]
  - [[首席合规官签字签的到底是什么对过程负责而不是替结果兜底]]

## 相关笔记
- [[工作流卡-连接层维护SOP]] (共现关键词: link, 医疗, 枢纽)
