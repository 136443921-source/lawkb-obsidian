...
- 领域枢纽：[[连接枢纽-通用程序]]
- 同域语义关联：
  - [[R-PR-017]] · [[R-PR-016]] · [[R-PR-024]] · [[R-PR-023]]
  - [[R-PR-025]]

## 相关笔记
- [[案件关系图示例]] (共现关键词: 2026, ##, 示例)
- [[LTI文本监控器v4.0迁移与调用规范]] (共现关键词: 迁移, 2026, PR)
- [[AI工具WorkBuddy篇8换电脑后数据如何迁移]] (共现关键词: 迁移, 2026, 08)
- [[经验卡片-要素式文书实务-示范文本首选率超75%]] (共现关键词: 2026, 文本)
- [[法律文书防幻觉提示词_LTI校验版]] (共现关键词: LTI, ##, 文本)
