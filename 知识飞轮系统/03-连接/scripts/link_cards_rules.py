...
GROUPS = {
    ...
    # 2026-08-23 析出：慈善组织合同纠纷（慈法×合同交叉子主题）
    # 卡片分类「慈善组织合同纠纷」+ 规则子目录「慈善组织合同」共同挂载到独立枢纽，
    # 强化慈法×合同交叉规则卡；从通用合同域/慈法合规域析出，避免交叉知识被两大域稀释。
    "慈善组织合同纠纷": ("慈善组织合同", "连接枢纽-慈善组织合同纠纷", "慈善组织合同纠纷连接枢纽"),
}
