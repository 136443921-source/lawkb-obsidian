...
文件名可以叫CLAUDE.md，也可以叫AGENTS.md，或者[[知识飞轮系统/05-调用/协同命中/README|README]].md。这个文件是给AI的工作手册。
...
![ScreenShot_2026-04-19_125321_728](wechat_img_1778849639929_624.jpg)
...
![ScreenShot_2026-04-18_222512_902](wechat_img_1778849640040_481.jpg)

![cli](wechat_img_1778849640233_253.jpg)
...
---
*Source: [WeChat Article](https://mp.weixin.qq.com/s/MFtHLy8TS39O5-bZphXBJA)*




## 相关笔记
- [[向国家金融监督管理总局贵州监管局实名举报的完整流程]] (共现关键词: 合同, 医疗, 完整)
- [[医疗合规 & 医疗纠纷律师：AI 提效全景指南]] (共现关键词: 合同, 医疗, 公司)
- [[自动化与工具链]] (共现关键词: 工具, 关键词, ##)
- [[ClaudeCodeObsidian个人知识库从工具到思维的完整指南]] (共现关键词: 知识库, 慈善, 个人)
- [[用ObsidianCodex搭一个会主动思考的个人知识库]] (共现关键词: 共现, 知识库, 个人)
- [[个人品牌与合规同行-青年律师的数字化成长之路]] (共现关键词: 共现, 个人, 慈善)
- [[我花了两小时用WorkBuddyObsidian搭了一个会自己进化的个人知识库wiki]] (共现关键词: 共现, 知识库, 个人)
- [[AI工具WorkBuddy篇8换电脑后数据如何迁移]] (共现关键词: 工具, 医疗, 公司)
- [[一定要尽早用这个AI工具workbuddy的100条实操攻略]] (共现关键词: 共现, 医疗, 公司)
- [[新增文件列表-2026-07-14]] (共现关键词: 慈善, AI, 文件夹)
- [[IMA摄入量衰减诊断报告-2026-08-30]] (共现关键词: 慈善, 医疗, 文件夹)
- [[IMA候选池开采规程-v1.18]] (共现关键词: 文件夹, 医疗)
- [[病历记录完整率-关键诊疗记录缺失风险]] (共现关键词: 共现, 慈善, 医疗)
- [[公司法务必备数据合规完整知识手册]] (共现关键词: AI, 完整)
- [[知识飞轮系统/03-连接/概念页/用ObsidianCodex搭一个会主动思考的个人知识库]] (共现关键词: 知识库, 个人)
- [[经验卡片-制度-AI工具PHI保密红线]] (共现关键词: 工具, ##, 慈善)
- [[笔记助手/其它笔记/ClaudeCodeObsidian个人知识库从工具到思维的完整指南]] (共现关键词: 指南, 思维, 完整)
- [[数据合规完整知识手册-2026-08-14]] (共现关键词: ##, 合同, 完整)
- [[R-LN-020-电子证据采信以真实性合法性关联性三性完整为前提缺失原始载体或非法取证即排除]] (共现关键词: ##, 完整)
- [[R-CF-071-慈善组织信息公开真实完整及时重大资产变动与关联交易三十日内公开公募财务会计报告须审计]] (共现关键词: ##, 完整)
- [[案件生命周期管理系统/王德明担保合同纠纷案/向国家金融监督管理总局贵州监管局实名举报的完整流程]] (共现关键词: 完整, 合同)
- [[Workbuddy做PPT进阶版之宝藏工具pptmaster]] (共现关键词: 工具, AI)
- [[笔记助手/学习笔记/AI工具WorkBuddy篇8换电脑后数据如何迁移]] (共现关键词: 文件, 工具, AI)
- [[知识库/医法知识库/医疗合规 & 医疗纠纷律师：AI 提效全景指南]] (共现关键词: 工具, 合同, 指南)
- [[知识库/workbuddy 使用技巧/一定要尽早用这个AI工具workbuddy的100条实操攻略]] (共现关键词: 文件, 工具, AI)
- [[笔记助手/学习笔记/贵阳贵安律师综合素质能力提升培训/个人品牌与合规同行-青年律师的数字化成长之路]] (共现关键词: ##, 个人)
- [[知识库/workbuddy 使用技巧/我花了两小时用WorkBuddyObsidian搭了一个会自己进化的个人知识库wiki]] (共现关键词: 知识库, Obsidian, md)
- [[知识飞轮系统/03-连接/概念页/用ObsidianCodex搭一个会主动思考的个人知识库]] (共现关键词: 知识库, 文件夹, Obsidian)
- [[提示词库/一句话让AI替你打工WorkBuddy128个通用指令全解析]] (共现关键词: 合同, 文件夹, AI)
- [[案件管理/Templater快速配置指南]] (共现关键词: 指南, 合同, 文件夹)
